...
SpellCaster::SpellCaster(const std::string& name, int hitPoints, int damage, int mana, bool battleMagician):
    Unit(name, hitPoints, damage), magicState(new MagicState(mana, battleMagician)) {
